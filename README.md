# K-Weather Survival Map

Vue 수업에서 배운 기술로 만든 픽셀 게임형 대한민국 날씨 지도입니다. 직접 제작한 한국 지도에서 도시를 선택하면 인벤토리 Drawer가 열리고, 실제 날씨·5일 예보·대기질과 자체 지수인 **날씨 생존 난이도**를 확인할 수 있습니다.

공식 마인크래프트 이미지나 텍스처는 사용하지 않았습니다. UI와 지도는 코드로 직접 제작했고, 글꼴은 OFL-1.1인 Galmuri를 사용합니다.

## 주요 기능

- 드래그·방향 버튼·키보드 방향키로 움직이는 한국 픽셀 지도
- `el-slider`를 이용한 75~200% 확대·축소
- 서울·수원·부산·제주·광주·광양 도시 마커와 날씨 요약 Popover
...
| Element Plus      | Switch, Select, Slider, Button, Drawer, Card, Progress, Popover |
